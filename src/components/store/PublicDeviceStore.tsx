            ...
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5 text-center space-y-3.5 shadow-2xl animate-in zoom-in-95">
              ...
              <div className="bg-slate-950 border border-blue-500/30 rounded-2xl p-3 max-w-md mx-auto text-left space-y-1.5">
                ...
                <ul className="text-[10px] text-slate-300 space-y-1">
                  <li>১. সাপোর্ট টিম নিকটস্থ অনুমোদিত টেকনিশিয়ানকে ইনস্টলেশন অ্যাসাইনমেন্ট পাঠাবে।</li>
                  <li>২. টেকনিশিয়ান কাজ গ্রহণ ও সময় নিশ্চিত করলেই কেবল তার নাম ও ফোন নম্বর আপনার ফোনে এসএমএস যাবে।</li>
                  <li>৩. টেকনিশিয়ান স্পটে এসে কাজ শেষ করলে আপনি সন্তুষ্ট হয়ে কনফার্ম করবেন ও ডিজিটাল ওয়ারেন্টি পাবেন।</li>
                </ul>
              </div>
